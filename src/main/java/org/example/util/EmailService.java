...
public class EmailService {
    ...
    public static void sendPasswordReset(String toEmail, String userName, String otp) {
        String subject = "SmartPFE — Password Reset Code";
        String html = "<div style='font-family:Segoe UI,Arial,sans-serif;max-width:480px;margin:auto;background:#f4f6fb;padding:32px;border-radius:16px'>"
            + "<div style='text-align:center;margin-bottom:24px'>"
            + "<h1 style='color:#a12c2f;font-size:28px;margin:0'>SmartPFE</h1>"
            + "<p style='color:#888;font-size:13px;margin:4px 0 0'>Password Reset Request</p></div>"
            ...
            + "<p style='color:#555;font-size:13px;line-height:1.6'>Use the code below to reset your password. It expires in <strong>15 minutes</strong>.</p>"
            + "<div style='text-align:center;margin:28px 0'>"
            + "<span style='display:inline-block;background:#a12c2f;color:white;font-size:32px;font-weight:bold;letter-spacing:10px;padding:16px 32px;border-radius:12px'>" + otp + "</span></div>"
            + "<p style='color:#888;font-size:12px'>If you did not request this, you can safely ignore this email.</p></div>"
            + "<p style='text-align:center;color:#bbb;font-size:11px;margin-top:20px'>© 2026 SmartPFE</p></div>";
